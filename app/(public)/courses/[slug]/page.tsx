      ...
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Badge className="flex items-center gaspan-1 px-3 py-1">
            ...
            {course.chapter.map((chapter, index) => (
              <Collapsible key={chapter.id} defaultOpen={index === 0}>
                <Card className="p-0 overflow-hidden border-2 transition-all duration-200 hover:shadow-md gap-0">
                  ...
                  <CollapsibleContent>
                    <div className="border-chart-5 bg-muted/20">
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lesson.map((lesson, lessonIndex) => (
                          <div
                            key={lesson.id}
                            className="flex items-center gap-4 rounded-lg hover:bg-primary/10 p-2"
                          >
                            <div className="flex size-8 items-center justify-center rounded-full bg-background">
                              <PlayCircle className="size-4 text-muted-foreground group-hover:text-primary transition-colors border-2 border-primary" />
                            </div>
        ...
        <div className="sticky top-20">
          <Card className="py-0">
            <CardContent className="p-6">
              ...
              <div className="mb-6 space-y-3 rounded-lg">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-2">
                    <div className="flex size-8 items-center justify-center rounded-full text-primary">
                      <ChartBar className="size-4" />
                    </div>
                    <div>
              ...
              {isEnrolled ? (
                <Link href={"/dahsboard"}>Watch course</Link>
              ) : (
